...
<head>
    ...
    <meta name="description" content="Politica sulla Privacy di Multics Exchanger.">
    <meta name="keywords" content="Multics, Exchanger, privacy, policy, dati personali">
    <meta name="author" content="Tuo Nome/Team">
    <title><?php echo __('privacy'); ?> - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <div class="container mt-5 pt-5">
        <div class="text-center mb-5">
            <h1 class="display-4"><?php echo __('privacy'); ?></h1>
            <p class="lead"><?php echo __('privacy_lead'); ?></p>
        </div>
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card shadow">
                    <div class="card-body">
                        <h2><?php echo __('privacy_heading'); ?></h2>
                        <p><?php echo __('privacy_content'); ?></p>
                        <!-- Aggiungi qui i dettagli sulla privacy policy -->
                    </div>
                </div>
            </div>
        </div>
