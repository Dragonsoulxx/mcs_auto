...
<head>
    ...
    <meta name="description" content="Contattaci per supporto su Multics Exchanger.">
    <meta name="keywords" content="Multics, Exchanger, contatto, supporto, aiuto">
    <meta name="author" content="Tuo Nome/Team">
    <title><?php echo __('contact_us'); ?> - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <div class="container mt-5 pt-5">
        <div class="text-center mb-5">
            <h1 class="display-4"><?php echo __('contact_us'); ?></h1>
            <p class="lead"><?php echo __('contact_lead'); ?></p>
        </div>
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card shadow">
                    <div class="card-body">
                        <h2><?php echo __('contact_heading'); ?></h2>
                        <p><?php echo __('contact_content'); ?></p>
                        <form method="POST" class="mt-4">
                            <div class="mb-3">
                                <label for="contact_name" class="form-label"><?php echo __('contact_name'); ?></label>
                                <input type="text" class="form-control" id="contact_name" name="name" required placeholder="<?php echo __('placeholder_name'); ?>">
                            </div>
                            <div class="mb-3">
                                <label for="contact_email" class="form-label"><?php echo __('contact_email'); ?></label>
                                <input type="email" class="form-control" id="contact_email" name="email" required placeholder="<?php echo __('placeholder_email'); ?>">
                            </div>
                            <div class="mb-3">
                                <label for="contact_message" class="form-label"><?php echo __('contact_message'); ?></label>
                                <textarea class="form-control" id="contact_message" name="message" required rows="5" placeholder="<?php echo __('placeholder_message'); ?>"></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary w-100"><?php echo __('submit_contact'); ?></button>
                        </form>
                    </div>
                </div>
            </div>
