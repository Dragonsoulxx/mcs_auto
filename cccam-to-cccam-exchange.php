...
?>
	...
	<head>
		...
		<meta charset="UTF-8">
		<title>Multics Cccam to cccam auto exchange</title>
		<meta name="Keywords" content="best cccam exchager, multics cccam exchager, cccam exchager, auto cccam exchager,cccam exchage,multics cccam auto exchager tool, multics line exchanger, cccam to cccam exchanger, auto multics exchanger">
	...
	<body>
		...
		<header class="header section section--header">
			<div class="section__layout">
				<a href="index.php" class="header__logo"> <span data-aos="fade-right" data-aos-delay="50">CCcam</span> <span data-aos="fade-right" data-aos-delay="75">Auto Exchanger</span> </a>
			...
			<section class="section section--home">
				...
				<div class="section__layout">
					<div class="section__content">
						<h1 data-aos="fade-up" data-aos-delay="50">CCcam Exchange</h1> </div>
					...
					<div class="grid">
						<div class="grid__cell">
							<div class="section__content" data-aos="fade-up">
								<h2>
           CCcam Exchanging Reception [ <?php echo $multics_version; ?> ]
          </h2>
								<p> Add your Cline Details here if it will valid then you will receive our Cline in this page.</p>
								<?php if ($port)
{ //ok
}
else
...
?>
									<div class="hideforum">
										<center>
											<br><b><input type="text" name="host" placeholder="Domain or IP" id="mybip" value="" pattern="^[a-z.A-Z0-9_]+$" required>  
<input id="ip" type="text" placeholder="Valid IP" name="ip" DISABLED>
<input type="number" id="mybport" placeholder="Port" name="ports" pattern="^[a-zA-Z0-9_]+$" required>
<input type="text" name="users" id="mybuser" size="20" placeholder="Line Username" value="" pattern="^[a-zA-Z0-9_]+$"/>
     <input type="text" name="passs" id="mybpass" size="20" placeholder="Line Password" value="" pattern="^[a-zA-Z0-9_]+$"/>

<input id="processBtn2" type="submit" <?php if ($port) { } else { echo 'disabled'; } ?>></center>
</div>
     </center>
<div id="result2"></div><br>
<img id="sharesImg2" width="50px" src="images/filetransfer.gif" />
